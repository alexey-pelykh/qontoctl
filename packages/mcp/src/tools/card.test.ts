  ...
  describe("card_appearances", () => {
    it("returns card appearances", async () => {
      const appearances = [
        {
          card_type: "virtual",
          card_appearances: [{ id: "app-1", name: "Default", image_url: "https://example.com/default.png" }],
        },
        {
          card_type: "standard",
          card_appearances: [{ id: "app-2", name: "Classic", image_url: "https://example.com/classic.png" }],
        },
      ];
