 ...
 *
 * Returns only the attachment ID — the Qonto API's standalone upload endpoint
 * does NOT include `file_name`, `file_size`, `file_content_type`, `url`, or
 * `created_at` in its response. To obtain the full record, call
 * {@link getAttachment} with the returned ID.
 *
...
export async function uploadAttachment(
  ...
  return parseResponse(z.object({ attachment: UploadedAttachmentSchema }), response, "/v2/attachments").attachment;
}
