...
export const TransactionSchema = z
  .object({
    ...
    logo: z.object({ small: z.string(), medium: z.string() }).nullable().optional(),
    cashflow_category: z.object({ name: z.string() }).nullable().optional(),
    cashflow_subcategory: z.object({ name: z.string() }).nullable().optional(),
